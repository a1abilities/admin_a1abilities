export const API_URL = 'http://a1.sargatechnology.com'; // Config[KEY].API_URL;
export const AUTH_URL = 'http://a1.sargatechnology.com'; // Config[KEY].AUTH_URL;
export const API_CONSUMER = 'http://a1.sargatechnology.com'; // Config[KEY].API_URL;
