export const API_URL = 'http://newgc.godsconsciousness.com '; // Config[KEY].API_URL;
export const AUTH_URL = 'http://newgc.godsconsciousness.com '; // Config[KEY].AUTH_URL;
export const API_CONSUMER = 'http://newgc.godsconsciousness.com '; // Config[KEY].API_URL;
